 ...
 *
 * <p>The closed set is: politics | sports | crypto | economics | entertainment | other.
 *
 * <p>Rules are evaluated in declaration order; the first match wins.
 * Crypto is checked before politics to avoid "bitcoin price" → politics via "price" keywords.
 * If no keyword matches, "other" is returned and the caller should log at INFO so thresholds
